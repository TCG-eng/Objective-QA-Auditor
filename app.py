...
# 3. Two-Column System Splitter (Permanently Visible)
...
with col_results:
    ...
    if execute_btn:
        # Check for API key at the exact moment they try to click execute
        if not st.session_state["gemini_api_key"]:
            ...
            with st.status("Analyzing system telemetry alignment...", expanded=True) as status_container:
                ...
                # Initialize client safely inside execution loop
